...
export default ({ label, options, style, selected, customStyle, click, dark }) => {
	return (
		<div className={dark ? [global.IndicatorContainer, classes.dark, classes.RadioToggle].join(' ') : [global.IndicatorContainer, classes.RadioToggle].join(' ')} style={customStyle}>
			{label ?? 
