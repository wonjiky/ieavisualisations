...
function App() {
	...
	let projects = [
		...
		{ id: 5, item: 'Weather - by grid', url: '/weather-grid-2', component: WeatherByGrid_Vector, exact: true, pw: password[2], title: 'Weather: by grid - v2' },
		{ id: 6, item: 'ETP2020 CCUS', url: '/ETP2020-CCUS', component: CO2Map, exact: true, pw: password[3], title: 'ETP2020 - CO2 Map' },
		{ id: 7, item: 'ETP CCUS - US', url: '/etp-ccus-us', component: CCUS, exact: true, pw: password[3], title: 'ETP2020 - CO2 Map' },
		{ id: 8, item: 'ETP CCUS - Europe', url: '/etp-ccus-europe', component: CCUS, exact: true, pw: password[3], title: 'ETP2020 - CO2 Map' },
		{ id: 9, item: 'ETP CCUS - China', url: '/etp-ccus-china', component: CCUS, exact: true, pw: password[3], title: 'ETP2020 - CO2 Map' },
		{ id: 10, item: 'ETP2020 - CDD', url: '/ETP2020-cdd', component: CDDMap, exact: true, pw: password[3], title: 'ETP2020 - CDD Map' },
	];
